...
Editorial decisions have been refactored. If you have a plugin or theme which records an editorial decision or modifies the UI for recording an editorial decision, read the documentation about [decisions](http://localhost:4000/dev/documentation/en/decisions).
