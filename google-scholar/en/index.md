...
> If an article is published in multiple languages, Google Scholar will only index the primary language. If indexing of multilingual content or metadata is important for your journal, consider publishing separate works, one submission for each language.
{:.notice}
