...
description: A guide covering the settings and functions in the Administration panel accessible by Site Administrators.
...
![OJS hosted journals menu with 1 existing journal.](./assets/learning-ojs3.4-sa-hosted-journals.png)
...
**Create Journal** link will let you add a new journal to this OJS installation. Fill out the necessary details in the window that appears to create a new journal.
![Journal editing screen with title, description and path fields available to edit.](./assets/learning-ojs-3.4-hosted-journals-edit-modal.png)
...
**Edit** will let you change the title, description, or path of a journal. 
**Remove** will let you delete the journal from the installation. **Once you have confirmed that you wish to delete the journal, this action cannot be undone**.
...
**Users** will allow you to add and manage users associated with the journal. Once you've created a journal and completed your configurations, you will likely want to create a user account for the Journal Manager or Editor - see the [Users and Roles chapter](./users-and-roles.md) for details.
...
Clicking **Settings Wizard** will take you to the settings for that journal. This can be used to make adjustments to configurations on a per-journal basis. 
**Journal**: Functionally the same as the “Edit” button on the list of hosted journals. Freely change the title, description, or path of a journal.
...
**Language**: Enable different languages for various areas of the site. Consult the [Installing, Enabling, and Configuring Locales section of Using PKP Software in Multiple Languages](https://docs.pkp.sfu.ca/multiling-guide/) to learn more.
...
The “Site Setup” option will appear under “Site Management” in the Administration menu if you have two or more journals. This is where you can make configurations that apply to **your overall OJS installation**, particularly your main OJS site which contains a list of all hosted journals.
...
![OJS admin menu with site setup tab selected.](./assets/learning-ojs3.4-sa-site-settings.png)
...
Although one or more languages can be installed when first configuring OJS, the Site Administrator can later configure the default language of the site and install new locales to make other languages available for use by journals under Administration > Site Settings > Languages. 
![OJS admin menu with languages tab selected.](./assets/learning-ojs3.4-sa-languages.png)
Here you can see all installed languages, enable or disable languages, and set any language as the Default Locale (the language that new users will see when first visiting the site).
...
![OJS admin menu with plugins tab selected.](./assets/learning-ojs3.4-sa-plugins.png)
Information about how to install, uninstall, update, and configure plugins, as well as a list of all available plugins, please see [the Plugin Inventory](https://docs.pkp.sfu.ca/plugin-inventory/).
...
![OJS admin menu with navigation menus tab selected.](./assets/learning-ojs3.4-sa-menus.png)
These options are functionally identical to the Appearance options for individual journals. Consult [the Customize the Look of Your Journal section of Learning OJS for Journal Managers] as well as the [Designing Your Journal guide](https://docs.pkp.sfu.ca/designing-your-journal/) for more information.


#### Enable Bulk Emails {#bulk-emails}
Site Administrators can allow Journal Managers to send bulk emails to several user groups in a journal at one time. See [Users and Roles > Email Users](./users-and-roles#email-users). As the site administrator, you can use the site settings to select which hosted journals will be allowed to send bulk emails.
...
## Access Other Administrative Functions {#admin-functions}
In addition to the ability to manage hosted journals and site-wide settings, the Administration menu offers other administrative functions related to viewing system information, expiring user sessions, and clearing caches and logs.
...
![System information screen displaying current version, version history and server information.](./assets/learning-ojs3.4-sa-sysinfo.png)
...
> Detailed information about _config.inc.php_ configuration parameters can be found in the file itself.
{:.tip}
