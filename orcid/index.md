...
![Image of journal displaying authenticated iDs on the article page](en/assets/orcid-id-example.png)
...
![Image of ORCID displaying the source of an entry in an ORCID record](en/assets/orcid-publication-source.png)
