...
# Guía para el cumplimiento del Plan S en el OJS

> Colaboradores: Kate Shuttleworth, Mariya Maistrovskaya

## Introducción

### ¿Qué es el Plan S?

[Plan S](https://www.coalition-s.org/) es una iniciativa para la publicación de Acceso Abierto que fue lanzada en septiembre de 2018. El plan cuenta con el apoyo de cOAlición S, un consorcio internacional de organizaciones de financiación y ejecución de la investigación. El Plan S exige que, a partir de 2021, las publicaciones científicas que resulten de la investigación financiada con subvenciones públicas se publiquen en revistas o plataformas de acceso abierto que cumplan con la normativa.

La [cOAlition S](https://www.coalition-s.org/about/) está formada por un grupo de organizaciones nacionales de financiación de la investigación, con el apoyo de la Comisión Europea.

El grupo señala el compromiso de aplicar las medidas necesarias para cumplir su objetivo principal:

> A partir de 2021, todas las publicaciones académicas sobre los resultados de la investigación financiada por subvenciones públicas o privadas proporcionadas por consejos de investigación y organismos de financiación nacionales, regionales e internacionales, deben publicarse en revistas de acceso abierto, en plataformas de acceso abierto, o estar disponibles inmediatamente y, sin embargo, a través de repositorios de acceso abierto.

El plan S consiste en [diez principios adicionales](https://www.coalition-s.org/plan_s_principles/), y la guía está disponible en la [Implementación del Plan S](https://www.coalition-s.org/guidance-on-the-implementation-of-plan-s/) y [Guías técnicas y requerimientos](https://www.coalition-s.org/technical-guidance_and_requirements/).

### Implicaciones para las revistas OJS

Para investigaciones financiadas con cOAlition S cubiertas por los requisitos del Plan S. todos los artículos estudiados por pares deben publicarse en lugares que cumplan con los “Requisitos para los lugares de publicación”. Los centros de publicación individuales (como las publicaciones publicadas en el OJS) son responsables de asegurarse de que cumplen estos requisitos. Las revistas que no cumplan estos requisitos no serán adecuadas para artículos de carácter científico resultantes de la investigación financiada por cOAlition S.

Muchos de los requisitos del Plan S para las publicaciones representan las mejores prácticas de calidad, visibilidad e interoperabilidad en publicación especializada. Por ello recomendamos que las revistas adopten estas prácticas, independientemente de si tienen la intención de publicar artículos de carácter científico resultantes de la investigación financiada por la Coalición S.

### ¿Qué esperar de esta guía?

Esta guía está pensada para publicaciones publicadas en OJS que tienen la intención de cumplir con los Requisitos del Plan S descritos en [Parte III: Guía técnica y requisitos](https://www.coalition-s.org/technical-guidance_and_requirements/). Esta guía se diseña alrededor de los requisitos del Plan S, con secciones que reflejan los apartados (1.1 y 1.2) de los requisitos del Plan S. La guía ofrece recomendaciones específicas para la implementación de los requisitos en el OJS. En los casos en que se ha considerado oportuno, hemos incluido enlaces a otros documentos y orientaciones de PKP que ofrecen detalles adicionales sobre la aplicación de características y especificaciones.

Aunque haremos todo lo posible por mantener esta guía al día, la documentación del Plan S debe ser la que ofrezca la información más actualizada y detallada.
