...
book: learning-omp
version: 3.5
title: Learning OMP 3.5 (Open Monograph Press) - Editorial Workflow - Production Stage
description: A guide to the production stage of the OMP editorial workflow.
---
...
![The All in production queue showing a list of three submissions currently in the Production stage.](./assets/dashboard-production-omp3.5.png)
...
![The Production ready files section of the central panel containing the book manuscript files.](./assets/prod-ready-files-omp3.5.png)
...
![A submission record with a cursor hovering over the Publication Formats item under the Publication menu, with the Publication format window on the right side.](./assets/prod-publication-formats-omp3.5.png)


Click the “Add publication format” button.

![The Add publication format window with a field to enter a name, a publication format selection from drop down, a check box for physical format, a check box for linking to external content, and a field for an ISBN.](./assets/add-format-file-omp3.5.png)
...
![The Add publication format window with the Edit option being displyed.](./assets/edit-format-file-omp3.5.png)
...
![The Publication format window with a cursor hovering over Select Files.](./assets/publication-format-select-file-omp3.5.png)
...
![The Select files window displaying the files from Production stage .](./assets/publication-format-select-file2-omp3.5.png)
...
![The Publication format window with a cursor hovering over Change File](./assets/publication-format-change-file-omp3.5.png)
...
![The Upload a File Ready for Publication window](./assets/publication-format-change-file2-omp3.5.png)
...
![The publication format window with a cursor hovering over the Awaiting Approval link](./assets/publication-format-approval-omp3.5.png)
...
![The Chapters window with a cursor hovering over the Add Chapter button .](./assets/add-chapter-omp3.5.png)
...
![The Production window, with the Preview button in the top right corner of the page.](./assets/omp-preview-omp3.5.png)
...
![The Publication menu in OMP 3.5.](./assets/publication-menu-omp3.5.png)
...
![The Representatives Screen in OMP 3.5.](./assets/marketing-representatives-omp3.5.png)
...
![The Add Representative Screen in OMP 3.5.](./assets/marketing-add-representatives-omp3.5.png)
...
![Multilingual fields under the Title & Abstract page.](./assets/multilingual-omp3.5.png)
