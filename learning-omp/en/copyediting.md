...
book: learning-omp
version: 3.5
title: Learning OMP 3.5 (Open Monograph Press) - Editorial Workflow - Copyediting Stage
description: A guide to assigning and completing copyediting in the OMP editorial workflow.
---
...
![The All in copyediting dashboard view.](./assets/dashboard-copyediting-omp3.5.png)
...
![The Participants section including the Assign button.](./assets/participant-assigned-omp3.5.png)
...
![The Draft Files section of the central panel containing a manuscript file.](./assets/draft-files-omp3.5.png)
...
![Title & Abstract item under the Publication menu.](./assets/publication-menu-omp3.5.png)
...
![A cursor hovering over the Preview button of a submission record.](./assets/
submission-preview-omp3.5.png)
...
![The Upload/Select Files button in the Copyedited files section of the panel.](./assets/copyedited-files-3.5.omp.png)
...
![The selected file now appearing in the Copyedited Files section.](./assets/copyedited-file-uploaded-omp3.5.png)
...
![The Send to Production window with notification to the author.](./assets/send-to-prod-omp3.5.png)
