...
book: learning-omp
version: 3.5
title: Learning OMP 3.5 (Open Monograph Press) - Editorial Workflow - Publication & Post-Publication
description: A guide to publishing manuscripts in your press and managing your catalogue in OMP 3.5.
---
...
![Publish button in OMP.](./assets/publish-omp3.5.png)

This will prompt a secondary box confirming you want to publish.
![Confirm publication window.](./assets/confirm-publication-omp3.5.png)

Once you’ve published the manuscript, you will see the status change in the following places.
![Published book submission record with the status tag set as ‘Published’.](./assets/published-book-omp3.5.png)
...
![The title and abstract screen of a manuscript showing the current version number of two, a dropdown menu listing each version and its publication date, the Unpublish button, and the Create New Version button.](./assets/version-view-omp3.5.png)
...
![List of dates for all versions for article that displays on the article abstract page on the front end.](./assets/version-reader-view-omp3.5.png)
...
![Warning notification of outdated version on a book abstract page and prompt to read the most recent version.](./assets/outdated-book-omp3.5.png)


Example of an outdated version message on the PDF chapter page:

![Warning notification of outdated version on PDF viewer and prompt to read the most recent version.](./assets/outdated-pdf-chapter-omp3.5.png)
...
![Catalog window in OMP 3.5.](./assets/catalog-omp3.5.png)
...
1. Click Catalog entry on the left panel of the Publication menu
2. Enter and select the necessary information for this manuscript
3. Click Save.

![Catalog entry menu item in OMP 3.5.](./assets/catalog-entry-submission-omp3.5.png)
...
![Catalog entry menu item in OMP 3.5 with Feature and New release check boxes.](./assets/featured-new-release-omp3.5.png)
...
If you don’t see the entry, make sure you have enabled these features on the Homepage Content setting under Website Settings > Appearance > Setup.

![Featured and New releases setup options.](./assets/featured-new-release-setup-omp3.5.png)
...
![List of Contributors in OMP.](./assets/learning-omp3.5-contributors-publication-list.png)

When entering contributors, the submitting author will have the option to identify authors in lists of publications.

![Check box option to include contributors in the browse list.](./assets/learning-omp3.5-contributors-publication-list-2.png)
...
![Catalog browse with a publication title and author's name](./assets/learning-omp3.5-catalog-browse-3.png)


### Highlight author as a volume Editor {#highlight-volume-editor}
...
![Catalog browse contributors with radio buttons with the Volume editor option available.](./assets/learning-omp3.5-catalog-author.png)
...
![Role Options under Volume Editor with the box checked in ‘Show role title in contributor list’.](./assets/learning-omp3.5-catalog-author-2.png)
...
![Submission record with a highlight under the Catalog Entry menu item and with highlights in the Series option.](./assets/learning-omp3.5-catalog-entry-series.png)
