...
book: learning-omp
version: 3.5
title: Learning OMP 3.5 (Open Monograph Press) - Editorial Workflow - Review Stage
description: A guide to assigning reviewers for internal and external review in the OMP editorial workflow.
---

# The Review Stage: Assign Internal or External Reviewers and Make an Editorial Decision
The second stage of the Editorial Workflow is the Review stage. This stage is started after selecting the Send to Internal Review option on the monograph’s Submission page. By sending the manuscript for Internal Review, other Editors can review this manuscript.
...
OMP is able to accommodate different types of reviews and has built-in steps to ensure anonymity, but it is the responsibility of the Editors to ensure the anonymity of reviewers and authors as required.

>Note: All participant information will be visible to Editors regardless of the type of review selected. 

Although the type of review be automatically selected based on what has been configured by the Press Manager, editors can also choose from the following review type options when sending review requests:
...
While OMP protects the information of anonymous authors and/or reviewers within the system, additional steps are often needed to fully anonymize a submission. 

In addition to author names being included in title pages, chapter/book manuscript, footnotes, references, and other areas of the document, the software used to draft the submission files may include information that could identify the author(s) within the document properties.

![A sample of a document whose author is visible within the document properties.](./assets/doc-properties-3.5.png)


Depending on your press policy, authors may be required to submit anonymized submission files, or you as the assigned editor may be required to anonymize the submission files yourself.
...
![The Edit button in the expanded menu under the list of review files.](./assets/internalreview-files-menu-OMP35.png)
...
![The Needs reviewers Dashboard view ](./assets/internalreview-assign-reviewers-OMP35.png)
...
![The Locate a Reviewer window listing all potential Reviewers.](./assets/internalreview-add-reviewer-OMP35.png)
...
![A sample of expanded reviewer details with review history and notes.](./assets/internalreview-reviewer-details-OMP35.png)
...
![The Add Reviewer screen with sample Important Dates, Files for Review, Review Type, and Review form settings..](./assets/internalreview-assign-settings-OMP35.png)
...
![The Reviewers section of the central panel with a list of reviewers and status of their review requests, important deadlines, review type, and an option to send a reminder for overdue responses. ](./assets/internalreview-reviewer-panel-status-OMP35.png)
...
![The expanded three dots menu beside a reviewer with options to view review details, email reviewer, edit, cancel reviewer, view history, login as user, and view editorial notes.](./assets/internalreview_reviewer-menu-OMP35.png)
...
![The Review Details window.](./assets/internalreview_review-details-OMP35.png)
...
![A sample review request marked "Request cancelled".](./assets/internalreview-review-cancelled-menu-OMP35.png)
...
**Log Response”: This option will allow you to record a response on behalf of the reviewer.
...
The “Cancel Review Round” button is available in the actions menu. You can unassign or cancel all reviewer assignments to cancel a review round. 

> If this is the first and only review round, the submission will return to the Submission stage.
{:.tip}

![List of review actions including the Cancel Review Round button.](./assets/internalreview-cancel-round-OMP35.png)
...
![The All in peer review dashboard view, which shows circle icons representing the status of each review assignment.](./assets/internalreview-dashboard-review-status-OMP35.png)
...
![An example of the pop-up that appears when clicking a circle icon with contextual options depending on the status of the review.](./assets/internalreview-icon-expand-OMP35.png)
...
![A Review stage status notification that reads “New reviews have been submitted”.](./assets/internalreview-reviews-submitted-OMP35.png)
...
![A sample review with comments.](./assets/internalreview-sample-review-OMP35.png)
...
![The Complete status applied to a review, along with options to thank the reviewer and revert the decision.](./assets/completed-review-OMP35.png)


You will also find new options:
* **Thank Reviewer**: Select this option to send a thank you email to the reviewer.
* **Revert Decision**: Select this option to mark this review as unconsidered and restore the Read Review option.
...
![The various action buttons for making a decision regarding a submission.](./assets/internalreview-cancel-round-OMP35.png)
...
**Send to External Review**: Use this option if you are satisfied that the submission is appropriate for the press, and to move the submission to the external review stage.
...
**Create New Review Round**: Use this to open a new internal review round. You can open as many review rounds as necessary to come to a decision. 

**Cancel Review Round**: Use this to unassign or cancel all reviewer assignments. If the submission is in its first review round, the submission will be moved back to the Submission stage. If the submission is in its second review round, the submission will be returned to Review Round 1.
...
![The Accept Submission author notification screen.](./assets/copyediting-accept-article-OMP35.png)
...
![The Require New Review Round prompt on the Request Revisions screen.](./assets/request-revisions-OMP35.png)
...
![The updated review status and the revised manuscript in the Revisions Submitted panel.](./assets/revisions-submitted-OMP35.png)
...
![The Review Round 2 item under the Workflow menu.](./assets/multiround-OMP35.png)
...
![An example of the Previous Reviews section seen by Reviewers when participating in an additional review round..](./assets/previous-reviews-OMP35.png)
