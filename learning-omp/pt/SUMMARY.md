...
* [Setting up and Maintaining Your Press](./press-setup.md)
  ...
  * [Configurações do Site](./press-setup.md#website-settings)
  * [Configurações do fluxo de trabalho](./press-setup.md#workflow-settings)
  * [Distribution](./press-setup.md#distribution)
* [Ferramentas](./tools.md)
  * [Importação/Exportação](./tools.md#importexport)
  * [Estatísticas](./tools.md#statistics)
* [Role-specific Workflows](./role-specific-workflows.md)
  ...
  * [Fluxo de trabalho editorial](./role-specific-workflows.md#editorial-workflow)
