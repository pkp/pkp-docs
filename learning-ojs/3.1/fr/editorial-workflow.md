...
1. Convertissez le document Word. You can use this [free online tool](https://word2cleanhtml.com/) to do an initial conversion.
...
Si nécessaire, modifiez le nom du fichier. Hit **Continue**.
