...
version: 3.3
showPageTOC: true
title: Aprendiendo Open Journal Systems 3.3 - Autores
description: Una guía sobre cómo enviar un manuscrito a una revista de OJS como autor.
---

# Autores

En este capítulo aprenderá cómo trabaja un autor en OJS, desde el registro de usuario hasta la revisión de la galerada final.

{% include video.html id="U5ddAXdB6cqkb0cD" provider="youtube" title="Enviar un artículo en OJS 3.3"%}
Este vídeo de PKP School explica cómo un autor puede registrarse en una revista y enviar un artículo. Para ver otros vídeos de esta serie, visita [el canal de YouTube de PKP](https://www.youtube.com/playlist?list=PLg358gdRUrDUKJbWtr4bgy133_jwoiqoF).

## Registrarse en la revista

Para realizar un envío a una revista en OJS 3, primero es necesario que registrar una cuenta de usuario en una revista e iniciar sesión \(vea [Registrándose en una revista](./user-accounts#registering-with-a-journal)\). Tras esto, cuando inicie sesión, será llevado a su Panel de Control.
...
En OJS 3.3 los autores pueden subir varios archivos a la vez, también pueden arrastrarlos y soltarlos para subirlos al envío.
...
Una vez que los archivos hayan sido cargados y etiquetados, es necesario hacer click en **Guardar y Continuar** para seguir con el **Paso 3**.
...
Es posible añadir más colaboradores \(p.ej. coautores\), haciendo clic en el enlace **Añadir colaboradores**. Esto abrirá una nueva ventana con campos para introducir sus datos.
...
En OJS 3, los autores pueden editar los metadatos de su envío en diferentes etapas del flujo de trabajo editorial. Esto dependerá de la configuración concedida por la Revista. Es posible que tenga permisos globales para realizar ediciones o que tenga que enviar una solicitud al Editor para hacerlo.
...
Para obtener más información acerca de la creación de metadatos, se recomienda leer nuestra [Guía de Buenas Prácticas en Metadatos](/metadata-practices/en/) (disponible en inglés).

<hr />

## Respondiendo a una revisión

{% include video.html id="mpGnu60y7-8" provider="youtube" title="Responder a revisiones en OJS 3.3"%}
Este video de PKP School explica cómo un editor responde a una revisión y cómo un autor puede subir revisiones. Para ver otros vídeos de esta serie, visita [el canal de YouTube de PKP](https://www.youtube.com/playlist?list=PLg358gdRUrDUKJbWtr4bgy133_jwoiqoF).
...
{% include video.html id="_gB_CH9Zjcw" provider="youtube" title="Proceso de Corrección en OJS 3.3"%}
Este video de PKP School explica el proceso de corrección, incluyendo cómo un editor puede responder a una solicitud de corrección de originales o corrección de pruebas. Para ver otros vídeos de esta serie, visita [el canal de YouTube de PKP](https://www.youtube.com/playlist?list=PLg358gdRUrDUKJbWtr4bgy133_jwoiqoF).
