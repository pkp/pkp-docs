...
Componentes são os tipos de arquivos que os autores podem enviar para a revista. Normalmente, um arquivo será o texto do artigo e outros podem incluir transcrições de entrevistas, dados, imagens, etc. Os componentes disponíveis para o autor escolher ao fazer sua submissão estão listados aqui. The components available for the author to choose from when making their submission are listed here.
...
**Prazos de Resposta Padrão:** indicam quanto tempo os avaliadores têm para decidir aceitar ou utilizar uma solicitação de Avaliação do editor e quanto tempo eles têm para realizar uma recomendação.
...
| Password Reset Confirmation - PASSWORD_RESET_CONFIRM                                       | Este e-mail é enviado a um usuário cadastrado quando este indica que esqueceu sua senha ou não consegue fazer o login. Ele fornece uma URL que eles podem acessar para redefinir a senha.                                                                                                                                                                                                                                                                                                                | Sistema                                | Usuário Registrado                 |                                    |
...
| Notice of Subscription Expiry - SUBSCRIPTION_BEFORE_EXPIRY                                 | Este e-mail notifica um assinante que sua assinatura irá expirar em breve. It provides the journal's URL along with instructions for access.                                                                                                                                                                                                                                                                                                                                                             | System                                 | Subscriber                         |                                    |
...
| Subscription Purchase: Institutional - SUBSCRIPTION_PURCHASE_INSTL                         | | Sistema                                 | Gerente de assinaturas                      |                          | | Subscription Purchase: Institutional - SUBSCRIPTION_PURCHASE_INSTL                                   | Este e-mail notifica o gerente de assinaturas de que uma assinatura institucional foi adquirida online. Ele fornece informações resumidas sobre a assinatura e um link de acesso rápido à assinatura adquirida.                                                          | System                                 | Subscription Manager               |                                    |
| Subscription Renewal: Individual - SUBSCRIPTION_RENEW_INDL                                 | | Sistema                                   | Gerente de assinaturas                       |                          | |Renovação de Assinatura Individual - SUBSCRIPTION_RENEW_INDL | Este e-mail notifica o gerente de assinaturas de que uma assinatura individual foi renovada online. It provides summary information about the subscription and a quick access link to the renewed subscription.                                                                                                | System                                 | Subscription Manager               |                                    |
| Subscription Renewal: Institutional - SUBSCRIPTION_RENEW_INSTL                             | |   | | Renovação de Assinatura Institucional - SUBSCRIPTION_RENEW_INSTL                                   | Este e-mail notifica o gerente de assinaturas que uma assinatura institucional foi renovada online. It provides summary information about the subscription and a quick access link to the renewed subscription.                                                                                                                                                                           | System                                 | Subscription Manager               |                                    |
