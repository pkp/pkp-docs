...
![The Archives tab listing rejected and published submissions.](./assets/learning-ojs3.1-ed-dashboard-archive.png)
...
![The Change Decision button in the submission status.] *La capture d'écran ci-dessus montre le bouton de décision pour MS# 425 avant l'enregistrement d'une décision. La capture d'écran ci-dessous montre la notification de la décision enregistrée.*
...
*Reviewer*: The reviewer will not be able to see the author(s) in their reviewer’s queue if the editor has selected a double-blind review. All identifying information in the metadata of the submission details is automatically removed by the system, as seen in the example below.
...
![A sample notification for a journal with APCs enabled.](./assets/learning-ojs3.1-jm-subscriptions-authorfees.png) Appuyez sur le bouton **Enregistrer la Décision Éditoriale** pour envoyer le message.
