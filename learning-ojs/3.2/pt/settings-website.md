...
OJS is multilingual, which means that the interface, emails, and published content can be available in multiple languages on a single site or journal. Assim, ao instalar o OJS, você pode selecionar um ou mais idiomas para o seu site.
