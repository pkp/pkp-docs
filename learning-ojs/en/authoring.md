...
To make a submission to an OJS 3.1 journal, you will first need to register a user account with a journal and log in \(see [Registering with a Journal](./registering_with_a_journal.md)\). After that, when you login, you will be taken to your Dashboard.
