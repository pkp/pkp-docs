...
| NOTIFICATION                       | The email is sent to registered users that have selected to have this type of notification emailed to them. This includes notifications of announcements and new issues published.                                                                                                                                                                                                                                                                                                                         | System                             | Registered User       |                          |
...
| New Issue Published                | This email is not yet used in OJS 3.                                                                                                                                                                                                                                          | System                             | Registered Users      | Publish                  |
