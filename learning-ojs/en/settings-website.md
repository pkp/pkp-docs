...
### Content Enchancement/Discovery Plugins
...
#### AddThis Plugin 
[AddThis](http://www.addthis.com/) permits easy social media sharing by integrating tools for several platforms into a compact set of configurable buttons. The pluginintegrates AddThis into OJS/OMP for quick sharing of published content.

This plugin can be enabled from the Plugin Gallery.

![](./assets/learning-ojs-settings-plugin-addthis.png)

You can configure the social media icons as well as get statistics by clicking on the Setting button of the Plugin.
...
* The display and order of blocks can be edited from the Sidebar Management section of Dashboard > Settings > Website > Appearance. 

For **OJS 3.2+**   Dashboard > Settings > Website > Appearance > Setup.
...
7. Additional custom timeline parameters can be added if you want, e.g. ````<a class="twitter-timeline" "data-tweet-limit="3" ...````
8. Click **Save**
...
permitting annotation and commenting. It currently supports commenting on HTML galleys.
