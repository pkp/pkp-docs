...
If your student journal is using OJS 3.1.2 or newer there is the option to use the free PKP PN Plugin which deposits your content in the PKP Preservation Network(PN), is available for OJS For instructions on enabling the PKP PN, see [PKP Preservation Network Guide](https://docs.pkp.sfu.ca/pkp-pn/)
