...
### Read Me file
The Readme.md file should include a brief introduction regarding the document, list of contributors, release date, and copyright.
...
As most users will not have direct access to make changes to the pkp repository, they will need to create a branch to make any changes. If you do not have full permission you will come across the message box below.
