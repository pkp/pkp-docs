...
description: This guide helps PKP software users to troubleshoot problems with OJS, OMP, and OPS software.
...
This guide helps PKP software users to troubleshoot problems with OJS, OMP, and OPS software. It outlines available resources and guides you through some suggested steps to find solutions to common issues.
...
| Desire to customize PKP software                                              | [PKP Technical Docs](https://docs.pkp.sfu.ca/dev/), [GitHub Repositories](https://github.com/pkp/)       |
...
##### General PKP guides (for non-technical audiences)

- [Learning OJS 3](https://docs.pkp.sfu.ca/learning-ojs/): a comprehensive guide on how to use OJS for journal managers, editors, reviewers, and authors. It explains journal setup, editorial workflow, and OJS tools.
...
- [PKP Software FAQ](https://docs.pkp.sfu.ca/faq/en/): list of frequently asked questions and responses related to PKP software.

##### Technical guides (for technical audiences)

- [PKP Administrators’ Guide](https://docs.pkp.sfu.ca/admin-guide/en/): for systems administrators of PKP software. It includes instructions on managing the server environment, importing and exporting, security, and configuring statistics and email.
- [Upgrade Guide](https://docs.pkp.sfu.ca/dev/upgrade-guide/): for systems administrators, focused on how to complete OJS upgrades.
- [Developer Documentation](https://docs.pkp.sfu.ca/dev/): a guide for coders who may want to customize or contribute to PKP software development.

##### General publishing guides (for non-technical audiences)
...
The Forum is also a great place to:
...
The PKP Forum is an active community space, with an average of 53 topics posted per day. PKP staff members, development partners, and software users around the world visit the forum every day and provide support to other users using the forum.
...
Responses to forum posts in languages other than English, similar to PKP documentation, are dependent on participation and contribution from particular communities.

#### GitHub

[GitHub](https://github.com) is the online space where PKP software development is managed and discussed. GitHub is a commonly used platform for open source software development because it makes the development process open and transparent and allows users to contribute code, provide input on issues or features, and reuse code for other projects.

PKP stores all the code for its software applications (OJS, OMP, OPS) and plugins [in GitHub](https://github.com/pkp). As software developers build the software, they add their code to the GitHub repository and the code is packaged into [software releases](https://github.com/pkp/pkp-lib/tags). Different versions of the software are stored in the GitHub repository, and software developers can track what features, changes, and bug fixes are included in different software versions. An overview of the versioning system used by PKP software can be found in the [upgrade guide](https://docs.pkp.sfu.ca/dev/upgrade-guide/en/#a-note-on-versions).

Users can download software from GitHub and install it locally. Users can get patches and bug fixes from GitHub and apply them to their own software installations (much of this is explored in the [administrator’s guide](https://docs.pkp.sfu.ca/admin-guide/en/)). The code can also be used to develop other applications, so long as the rules of the [license](https://github.com/pkp/pkp-lib/blob/main/LICENSE) are respected.
...
Before you start looking for help, you should note which specific version you are running (e.g. OJS 3.3.0-11) and clarify as much as possible what your issue or question is. This will help you find relevant documentation and to post better questions on the forum should the documentation not be enough to resolve your issue. Having a good sense of what your problem is will allow you to find answers more quickly and enable you to articulate it more clearly to get help.
...
- What is the size and file type of the image you’re trying to upload?

### 2. Search for documentation

Once you’ve clarified your problem, search the Documentation Hub or the PKP Forum for possible solutions. The Documentation Hub may be more helpful if you need to verify that you’ve understood a workflow or set up steps properly. The Forum may be more helpful if you are experiencing a specific error when trying to complete a task.
...
The Documentation Hub has a search feature that enables users to search across the entire documentation hub for their specific queries. The search feature may be found on select guides within the documentation hub as well.
...
2. Using the “Sort by” option to identify relevant posts (e.g. by Relevance, Latest Post, and Most Viewed tend to be most helpful).
...
It is important to note that support on the PKP Community Forum is provided for free by PKP staff and community members. PKP staff are particularly active on the forum, however, it should be noted that PKP is a small team and needs to balance time spent answering questions on the Forum with other work developing and maintaining our free and open source software and services. We cannot guarantee that every question will be answered or that every issue is resolved. As such, we ask that users of the forum have appropriate levels of patience and reasonable expectations, and follow the [forum guidelines](https://forum.pkp.sfu.ca/t/forum-guidelines-and-code-of-conduct/37) when posing questions on the forum.
...
Including the specific version number and software you are using will help those who may respond to your post potentially test the issue out using an appropriate version. If the issue you are facing has been resolved, they may be able to point out how your issue may be remedied by applying a patch to your software or by upgrading the version of your software to a version where your issue has been resolved. Please see the [forum post on how to determine your version](https://forum.pkp.sfu.ca/t/how-do-i-determine-my-pkp-softwares-version/28534) if you are unsure of how to determine which version of the software you are using.

Providing a detailed explanation of the issue. Include what steps you have taken to try and resolve the issue and what the results were, which can be extremely helpful for PKP staff and community members who would like to help. It can be challenging for those trying to answer questions on the forum if only minimal information is provided and problems are not articulated properly. Users of the forum are also highly encouraged to share their expertise in working with various aspects of PKP software.
...
![A screenshot of the milestones used in PKP GitHub issues](./assets/pkp-github-milestones.png)

In this case, this issue is associated with the milestone of the OJS/OMP/OPS 3.3.0-21 release and would be included as part of that version of the software. The milestone refers to the earliest version of the software that the fix will be released in; for example, if the milestone is set to 3.3.0-21, then the fix will also be applied to releases of 3.4.0 and 3.5.0 (usually the corresponding versions that are released on the same date).
...
- Go to the [pkp-lib GitHub repository](https://github.com/pkp/pkp-lib).
- In the Search box on the top left of the page, enter search terms and press Enter. For this example, we will enter “copyeditor metadata” in the search field (see below for tips on choosing search terms). 
- Remember that GitHub is mainly developers who are creating issues and may use different terminology than a regular user. For example, if you are having an issue with adding or uploading content to a text field in your OJS site, you may say the problem is with “upload image” or “text box.” However, a developer will know that the text field uses a plugin called TinyMCE and they may explain the issue as a problem with TinyMCE. 
...
3.  Search GitHub for issues that refer to the same problem. Go to [the pkp-lib repository](https://github.com/pkp/pkp-lib/issues) and do a keyword search for open and closed issues.

If you find the same issue on GitHub, and it’s closed, look at the milestone software release and check it against the version of the software being used. In some cases, applying the bug fix may require that you either upgrade to a new version of the software where the fix was completed or apply a patch to solve the issue (often done by a systems administrator or your web host).
...
Sometimes your issue is not related to the software itself and could be a problem with your server, webhost, email provider, internet provider, or other software applications that work with PKP software. If this is the case, here are some other resources to consult.
