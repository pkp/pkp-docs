...
## [Can a reviewer change a recommendation they already submitted?](#-change-recommendation)
...
## [How can a reviewer upload an attachment after the review has been submitted?](#-attachment-after-submission)
...
## [How do I cancel a new review round that was accidentally opened?](#-cancel-review-round)
...
## [I’m an editor so why can’t I record an editorial decision?](#-limited-privilege)
...
## [How can I change the wording of reviewer recommendations?](#-customize-review-recommendations)
...
## [Why did a user not receive a notification about a submission?](#-submission-notification)
...
## [How do I make the galley file links appear in the issue table of contents?](#-galleys-in-toc)
...
## [Why are the HTML galley files not being displayed or identified properly?](#-galley-display)
...
## [How do I delete an article from OJS?](#-delete-article)
...
## [How do I disable submissions for my journal or press?](#-disable-submissions)
