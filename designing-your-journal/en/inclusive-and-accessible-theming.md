...
Additional online tools such as [Wave browser extension](http://wave.webaim.org/extension) (free) or [axe DevTools](https://www.deque.com/axe/) (free) can facilitate website auditing. Tabbing through your pages with your keyboard and using a screen reader such as [NVDA](https://www.nvaccess.org/) (free) [JAWS](https://www.freedomscientific.com/products/fs/jaws-product-page.asp), or [VoiceOver](https://support.apple.com/en-ca/guide/voiceover/welcome/mac) (free) can help ensure that your website is accessible.
