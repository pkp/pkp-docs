...
The dashboard allows you to see where submissions are in the workflow and sort your tasks accordingly.
...
**Incomplete**: The author has not completed the submission. *New in 3.5*: Preprint Server Managers can remove submissions with the Incomplete status by pressing the three dots next to the “Filter” button and choosing “Delete Incomplete Submissions”. 

![The Active Submissions dashboard displaying the option to Delete Incomplete Submissions](./assets/delete-incomplete-3.5.png)


**Submission**: The submission either requires a moderator to be assigned, or requires the assigned moderator to review and make a decision to reject or post the preprint.

**Production**: The submission is ready to be prepared for or is currently being prepared for posting.

**Scheduled for Publication**: The submission has been finalized and scheduled for posting at a future date.

**Published**: The submission is posted and available to readers.

**Declined**: The submission was declined. Note that this status is only viewable to Preprint Server Managers.

You can use the various views under the Dashboards menu to filter submissions by these statuses.

> Note: The “Declined” Dashboard view is only accessible to roles with the Preprint Server Manager permission level. 
{.:tip}
...
![The Filters menu of the Dashboard with options to filter by assigned moderator, category, and/or date since last activity.](./assets/filters-menu-3.5.png)
...
![The expanded Tasks menu in OPS.](./assets/tasks-3.5.png)
...
Moderators receive a weekly email summary of submissions which require editorial actions, including notifications for:
...
The **Workflow menu**: This where you can view the work for this submission in the two stages of Submission and Production. You can click “Workflow” to expand or collapse these options.
...
You can also click the three dots next to a participant's name to access options to Edit, Notify, Login As (this option is only accessible to Preprint Server Managers), or Remove them. 
...
Clicking Edit will allow you to change the participant’s privileges related to the submissions. For example, you can disallow or allow Authors to make changes to the publication, such as the title, abstract, or other information.
...
The **Activity Log** is accessible to Moderators on the top right of the submission record. The Activity Log keeps a record of all decisions and actions taken during the editorial workflow, including any sent emails.

![A sample activity log for a submission.](./assets/activity-log-3.5.png)

The **Notes** tab of the Activity Log can be used to add editorial notes. These notes are only visible to assigned Moderators, Preprint Server Managers, and Site Administrators.
...
OPS allows participants in each stage to use discussions to communicate about the work. Each stage has its own distinct discussion panel, and only participants assigned in that stage will have access to the stage’s discussion panel. In addition to sending messages, discussions can also be used to upload and share related files. 
...
> As a general rule, the Preprint Server Manager can see all discussions in a stage. 
> Moderators and Authors will *only see discussions where they have been selected as participants*.
> Authors will not be able to use discussions to communicate with each other in Anonymous review.
...
> Creating discussions will send an email containing the message and attachment to participants. However, replying to this email from your inbox *will NOT log the communication in OPS*. If you wish to have a complete log of communication in OPS, users should be encouraged to use the Discussions panel to reply.
{:.tip}
