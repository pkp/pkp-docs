...
Instructions on how to create, edit, and manage sections is in [Learning OJS 3](/learning-ojs/3.2/en/journal-setup#sections).
...
Instructions on how to create, edit, and manage categories is in [Learning OJS 3](/learning-ojs/3.2/en/journal-setup#categories). Here’s an example of what adding a new category looks like:

![The Create Category screen in OPS.](./assets/learning-ops-server-settings-add-category.png)
...
The Website settings in OPS are very comparable to OJS/OMP. For an overview of this, please consult the [Learning OJS guide section on website settings](/learning-ojs/3.2/en/settings-website).
...
The Plugins tab under Website Settings lists pre-installed plugins under Installed Plugins and additional plugins under Plugin Gallery. See [Learning OJS](/learning-ojs/3.2/en/settings-website#installed-plugins) for information about how to install and use plugins. The list below highlights the plugins that are especially useful for OPS.
...
The workflow settings in OPS are very comparable to OJS/OMP. For an overview of this, please consult the [Learning OJS guide section on workflow settings](/learning-ojs/3.2/en/settings-workflow).
...
The distribution settings in OPS are very comparable to OJS/OMP. For an overview of this, please consult the [Learning OJS guide section on distribution settings](/learning-ojs/3.2/en/settings-distribution). OPS does not have the payment or archiving settings that you will find in OJS. The information provided below is what will be relevant to OPS.
