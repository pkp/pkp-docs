...
This guide can be used alongside [Learning OJS 3.2](/learning-ojs/3.2/en), which has information about how to use OPS that is common to both OPS and Open Journal Systems (OJS) – a similar open source software application for publishing scholarly journals.
